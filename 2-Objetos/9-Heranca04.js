...
meuObjeto.prototype.grito = () => console.log(`Repare que ao colocarmos arrow function, o this nao varia:nome=${this.nome}`)
     ...
     * this variar
     * de acordo com a função em que foi declarada. O this em funcçaõ arrow, nao foge do escopo, ou seja, não procura o 
     * atripudo fora
     * daquele lugar em que foi declarada. Ao tentar acessar this.nome por uma função arrow, sendo que nome não esteja 
     * declarada no
     * escopo da arrow, retornará undefined.
